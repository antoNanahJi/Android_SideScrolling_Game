...
public class SoundPlayer {
    ...
    private static int inGameSound;
    ...
    public SoundPlayer(Context context)
    {
        ...
        inGameSound = soundPool.load(context, R.raw.zero_trigger_forestfrenzy, 1);
    }
    ...
    public void playInGameSound(){soundPool.play(inGameSound, 1.0f, 1.0f, 1, 0, 1.0f);}
}
